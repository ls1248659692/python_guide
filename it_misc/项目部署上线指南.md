...
1. [注册域名](https://wanwang.aliyun.com/domain/)。
   ...
   ![](../static/markdown_pic/aliyun-domain.png)

2. [域名备案](https://beian.aliyun.com/)。

   ![](../static/markdown_pic/aliyun-keeprecord.png)

3. [域名解析](https://dns.console.aliyun.com/#/dns/domainList)。

   ![](../static/markdown_pic/aliyun-dnslist.png)

   ![](../static/markdown_pic/aliyun-resolve-settings.png)

4. [购买证书](https://www.aliyun.com/product/cas)。

   ![](../static/markdown_pic/aliyun-certificate.png)
