...
def check_industry_set():
    INDUSTRY_LIST = [
"潍柴动力","三一重工","中国重汽","星宇股份","银轮股份","劲嘉股份","巨星科技","豪迈科技","坚朗五金","麦格米特","伊之密","上海机场","白云机场","首都机场","福耀玻璃","均胜电子","浙江鼎力","安徽合力","长安汽车","拓普集团","捷佳伟创","上汽集团","江山欧派","伟星新材","欧派家居","北新建材","正泰电器","金卡智能","捷昌驱动","杰瑞股份"
    ]

    industry_list2 = [
"三一重工",	"上汽集团",	"上海机场",	"中国重汽",	"伊之密",	"伟星新材",	"劲嘉股份",	"北新建材",	"均胜电子",	"坚朗五金",	"安徽合力",	"巨星科技",	"拓普集团",	"捷佳伟创",	"捷昌驱动",	"星宇股份",	"杰瑞股份",	"欧派家居",	"正泰电器",	"江山欧派",	"浙江鼎力",	"潍柴动力",	"白云机场",	"福耀玻璃",	"豪迈科技",	"金卡智能",	"银轮股份",	"长安汽车",	"麦格米特"
    ]
